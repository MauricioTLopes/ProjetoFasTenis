...
<html lang="pt-br">
	...
	<body>
		...
		<nav>
			<div class="menu_ger">
				<button id="menua1" class="btmenu">tênis</button>
				<div id="menub1" class="menub">
					<a href="novo_sapato.php?num=<?php echo $n1 ?>" target="_self">novo</a>
					<a href="editar_sapato.php?num=<?php echo $n1 ?>" target="_self">editar</a>
					<a href="excluir_sapato.php?num=<?php echo $n1 ?>" target="_self">excluir</a>
